package com.taoxier.smartdochub.core.security.filter;
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        log.info("TokenAuthenticationFilter - URI: {}, Authorization: {}", request.getRequestURI(),
                authorizationHeader);
        ...
        try {
            if (StrUtil.isNotBlank(authorizationHeader)
                ...
                if (isValidToken) {
                    ...
                    log.info("已设置Authentication到SecurityContext");
                }
                // 如果Token无效，不返回错误，继续执行过滤器链
            }
        } catch (Exception ex) {
