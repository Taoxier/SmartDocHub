package com.taoxier.smartdochub.core.aspect;
...
import com.taoxier.smartdochub.common.enums.LogModuleEnum;
import com.taoxier.smartdochub.common.util.IPUtils;
import com.taoxier.smartdochub.core.security.util.SecurityUtils;
import com.taoxier.smartdochub.system.model.entity.Log;
import com.taoxier.smartdochub.system.service.LogService;
...
public class LogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.taoxier.smartdochub.common.annotation.Log)")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint, com.taoxier.smartdochub.common.annotation.Log logAnnotation) throws Throwable {
     ...
     * @param userId        用户ID
     */
    private void saveLog(final JoinPoint joinPoint, final Exception e, Object jsonResult, com.taoxier.smartdochub.common.annotation.Log logAnnotation, long executionTime, Long userId) {
